...
import { Clock, Package, User, Filter, Search } from 'lucide-react';
...
const MyTasks = () => {
  ...
  const [stats, setStats] = useState({ total: 0, assigned: 0, in_progress: 0, completed: 0, on_hold: 0 });
  ...
  const filteredTasks = tasks.filter(task => {
    ...
    const matchesSearch = !filters.search || 
      task.requestNumber?.toLowerCase().includes(filters.search.toLowerCase()) ||
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-500 mt-1">View and manage your assigned maintenance tasks</p>
        </div>
      </div>
                ...
                {filteredTasks.map((task) => (
                  ...
                  >
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm font-medium text-gray-900">{task.requestNumber}</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center">
                        <Package className="w-4 h-4 text-gray-400 mr-2" />
                        <span className="text-sm text-gray-900">{task.assetName || task.asset?.name || 'N/A'}</span>
                      </div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center">
                        ...
                        <span className="text-sm text-gray-600">{task.requesterName || 'Unknown'}</span>
                      </div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
